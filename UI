...
local PurpleBlackThemeMap = {
	["32,34,37"] = Color3.fromRGB(18, 18, 24),
	["41,43,47"] = Color3.fromRGB(26, 22, 36),
	["47,49,54"] = Color3.fromRGB(34, 28, 48),
	["54,57,63"] = Color3.fromRGB(46, 35, 62),
	["64,68,75"] = Color3.fromRGB(63, 48, 90),
	["35,35,35"] = Color3.fromRGB(20, 17, 28),
	["24,25,28"] = Color3.fromRGB(14, 12, 20),
	["31,33,36"] = Color3.fromRGB(24, 20, 34),
	["88,101,242"] = Color3.fromRGB(144, 95, 255),
	["114,118,125"] = Color3.fromRGB(176, 162, 220),
	["127,131,137"] = Color3.fromRGB(188, 176, 228),
	["153,170,181"] = Color3.fromRGB(204, 196, 236),
	["99,102,109"] = Color3.fromRGB(186, 170, 228),
	["220,221,222"] = Color3.fromRGB(236, 229, 255),
	["255,255,255"] = Color3.fromRGB(245, 240, 255),
	["40,43,46"] = Color3.fromRGB(38, 32, 54),
	["67,181,129"] = Color3.fromRGB(171, 94, 255),
}
...
local function ApplyPurpleBlackTheme(root)
	local function applyToObject(object)
		for propertyName, _ in pairs({
			...
			pcall(function()
				local currentColor = object[propertyName]
				if typeof(currentColor) == "Color3" then
					local replacement = PurpleBlackThemeMap[ColorKey(currentColor)]
					if replacement then
...
function DiscordLib:Window(text)
	...
	ApplyPurpleBlackTheme(MainFrame)
